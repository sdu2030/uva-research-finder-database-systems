...
if (isset($_POST['addBtn'])) {
    ...
    $priority_option = $_POST['priority_option'];
    echo "add button pressed" ;
    addRequests($requestedDate, $roomNo, $requestedBy, $requestDesc, $priority_option);
}
    ...
    updateRequest($reqId, $requestedDate, $roomNo, $requestedBy, $requestDesc, $priority_option);
}

else if (isset($_GET['del'])) {
    deleteRequest($_GET['del']);
    echo "delete button pressed" ;
}


else if (isset($_GET['edit'])) {
    $send_package = getRequestById($_GET['edit']);
...
<div class="container">
  ...
  <form method="post" action="<?php $_SERVER['PHP_SELF'] ?>" onsubmit="return validateInput()">
    <input type="hidden" name="reqId" value="<?php if ($send_package !=null && $send_package['reqId']) echo $send_package['reqId']; ?>">
        ...
        <td width="50%">
          <div class='mb-3'>
            ...
            <input type='text' class='form-control' 
                  ...
                  value="<?php if ($send_package !=null && $send_package['reqDate']) echo $send_package['reqDate']; ?>" />
          </div>
        </td>
        <td>
          <div class='mb-3'>
            ...
            <input type='text' class='form-control' id='roomNo' name='roomNo' 
                  value="<?php if ($send_package !=null && $send_package['roomNumber']) echo $send_package['roomNumber']; ?>" />
          </div>
        </td>
      </tr>
      <tr>
        <td colspan=2>
          <div class='mb-3'>
            ...
            <input type='text' class='form-control' id='requestedBy' name='requestedBy'
                  ...
                  value="<?php if ($send_package !=null && $send_package['reqBy']) echo $send_package['reqBy']; ?>" />
          </div>
        </td>
      </tr>
      <tr>
        <td colspan=2>
          <div class="mb-3">
            ...
            <input type='text' class='form-control' id='requestDesc' name='requestDesc'
                  value="<?php if ($send_package !=null && $send_package['repairDesc']) echo $send_package['repairDesc']; ?>" />
          </div>
        </td>
      </tr>
      <tr>
        <td colspan=2>
          <div class='mb-3'>
            ...
            <select class='form-select' id='priority_option' name='priority_option'>
              <option value=""></option>
              <option value='high' 
                <?php if ($send_package !=null && $send_package['reqPriority'] == 'high') echo 'selected="selected"'; ?>>

                High - Must be done within 24 hours</option>

              <option value='medium' 
                <?php if ($send_package !=null && $send_package['reqPriority'] == 'medium') echo 'selected="selected"'; ?>>

                Medium - Within a week</option>
              
                  <option value='low' 
                  <?php if ($send_package !=null && $send_package['reqPriority'] == 'low') echo 'selected="selected"'; ?>>
        ...
        <?php if (!empty($reqs)) : ?>
          ...
          <?php foreach ($reqs as $req) : ?>
            <tr>
              ...
              <td><?php echo $req['roomNumber']; ?></td>
              <td><?php echo $req['reqBy']; ?></td>
              <td><?php echo $req['repairDesc']; ?></td>
              <td><?php echo $req['reqPriority']; ?></td>

              <td><a href="?edit=<?php echo $req['reqId']; ?>">Edit</a></td>
              <td><a href="?del=<?php echo $req['reqId']; ?>">Delete</a></td>
            </tr>
          <?php endforeach; ?>
        <?php endif; ?>
      </tbody>
