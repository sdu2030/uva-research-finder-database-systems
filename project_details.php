...
<table class="w3-table w3-bordered w3-card-4 center" style="width:100%">
  ...
  <tr>
    <td><?php echo $proj_info['interested']?> </td>
    <td><?php echo $proj_info['title']; ?> </td> 
    <td><?php echo $proj_info['UID']; ?> </td> #create some logic to pull these associated values
    <td><?php echo $proj_info['paid_credit']; ?> </td>
    <td><?php echo $proj_info['num_students']; ?> </td>  
    <td><?php echo $proj_info['keywords']; ?> </td> 
    <td><?php echo $proj_info['qualifications']; ?> </td> 
